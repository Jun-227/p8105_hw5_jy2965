...
rejected is not approximately equal to the true value of beta1. Because
those beta1 in successfully reject null hypothesis group were collected
in the rejection area of t-test statistics, which had extreme values
different from 0.
